...
from ml import importing_250_movies
import pandas as pd
...
@app.route('/buscar_recomendation', methods=['GET', 'POST'])
def Buscar_recomendation():
    title = request.form['viaje'];
    print('Los ejercicios '+ title);
    print(recommendations(title));
    return render_template('index.html',viajes=recommendations(title))
